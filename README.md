...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/armin-taheri)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/armin-taheri
```

A live public deployment of this template is available at [https://armin-taheri.templates.workers.dev](https://armin-taheri.templates.workers.dev)
